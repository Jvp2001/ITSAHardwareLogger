...
final case class Media(@Id id: Long, 
                       ...
                       @SqlName("descr") descr: Option[String],
                       handle: Option[String]
                      ) extends HLEntityWithItsaID derives DbCodec

final case class MediaCreator(@SqlName("itsaid") itsaID: String, @SqlName("descr") descr: Option[String], handle: Option[String] = None) extends HLEntityCreatorWithItsaID derives DbCodec