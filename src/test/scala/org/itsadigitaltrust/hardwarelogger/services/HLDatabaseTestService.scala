...
//import org.itsadigitaltrust.hardwarelogger.services.database.CommonHLDatabase
...
//
//
//object HLDatabaseTestService extends CommonHLDatabase[HardwareLoggerTask](using ""):
