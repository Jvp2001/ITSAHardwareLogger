package org.itsadigitaltrust.hardwarelogger.hdsentinelreader
...
class HDSentinelReaderTests extends AnyFunSuite with HWLLoggable:
  ...
  import org.itsadigitaltrust.hardwarelogger.services.OshiHardwareGrabberApplicationService.given_Conversion_String_HardDriveConnectionType
  val xml = <HDSentinel>
    <Hard_Disk_Summary>
