...
class ModelWrapper[M](
   ...
   * name.get() // Luise
   * wrapper.commit() // put values from propertiesFilePath to the wrapped model object
   * p.getName() // Luise
   *
   * </pre>
   *
   ...
   * of one of the wrapped propertiesFilePath is changed. It will only change back to <code>false</code> when either the
   ...
   * <p/>
   *
   * Simply speaking: This property indicates whether there was a change done to the wrapped propertiesFilePath or not. The
   *
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, false, () => new BooleanProperty()))
//
//  def field(getter: BooleanGetter[M], setter: BooleanSetter[M], defaultValue: Boolean): BooleanProperty =
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, defaultValue, () => new BooleanProperty()))
//
...
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged(), accessor, false, () => new BooleanProperty()))
//
//  def field(accessor: BooleanPropertyAccessor[M], defaultValue: Boolean): BooleanProperty =
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, defaultValue, () => new BooleanProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, 0, () => new DoubleProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, defaultValue, () => new DoubleProperty()))
//
...
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, () => new DoubleProperty()))
//
//  def field(accessor: DoublePropertyAccessor[M], defaultValue: Double): DoubleProperty =
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, defaultValue, () => new DoubleProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, () => new FloatProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, defaultValue, () => new FloatProperty()))
//
...
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, () => new FloatProperty()))
//
//  def field(accessor: FloatPropertyAccessor[M], defaultValue: Float): FloatProperty =
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, defaultValue, () => new FloatProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, () => new IntegerProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, defaultValue, () => new IntegerProperty()))
//
...
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, () => new IntegerProperty()))
//
//  def field(accessor: IntPropertyAccessor[M], defaultValue: Int): IntegerProperty =
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, defaultValue, () => new IntegerProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, () => new LongProperty()))
//
...
//    addForegroundTask(new BeanPropertyField(this.propertyWasChanged, getter, setter, defaultValue, () => new LongProperty()))
//
...
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, () => new LongProperty()))
//
//  def field(accessor: LongPropertyAccessor[M], defaultValue: Long): LongProperty =
//    addForegroundTask(new FxPropertyField(this.propertyWasChanged, accessor, defaultValue, () => new LongProperty()))
//
