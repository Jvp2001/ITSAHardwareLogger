...
private[views] final class ProcessorTabView extends TabTableView(using classTag[ProcessorModel], TabTableViewModel(ProcessorTableRowViewModel.apply, _.processors)):
